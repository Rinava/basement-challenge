...
const FloatingShit = ({reference, variant}: FloatingShitProps) => {
  ...
  const scaleX = useTransform(xVelocity, [-3000, 0, 3000], [0.25, 1, 0.25], {
    clamp: false,
  });

  const scaleY = useTransform(yVelocity, [-3000, 0, 3000], [0.25, 1, 0.25], {
    clamp: false,
  });
  ...
  return (
    <motion.div
      drag
      className="z-50 relative w-48 h-48 opacity-75"
    ...
    >
      {variant ? (
        ...
        <svg fill="none" height="147" width="147" xmlns="http://www.w3.org/2000/svg">
          <path
